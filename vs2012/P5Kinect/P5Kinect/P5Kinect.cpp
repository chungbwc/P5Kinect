// P5Kinect.cpp : Defines the exported functions for the DLL application.
//
...
DWORD WINAPI P5Kinect::Nui_ProcessThread(LPVOID pParam)
{
	P5Kinect* pThis = (P5Kinect *) pParam;
	return pThis->Nui_ProcessThread();
}

DWORD WINAPI P5Kinect::Nui_ProcessThread()
{
	const int NUM = 4;
	HANDLE hEvents[NUM] = {
		m_hEvNuiProcessStop,
...
void P5Kinect::Nui_GotDepthAlert()
{
...
void P5Kinect::Nui_GotImageAlert()
{
...
void P5Kinect::Nui_GotSkeletonAlert()
{
...
int * P5Kinect::Nui_GetImage()
{
	return pixels;
}

int * P5Kinect::Nui_GetDepth()
{
	return depth;
}

int * P5Kinect::Nui_GetMask()
{
	return mask;
}
